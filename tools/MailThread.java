...
public class MailThread extends Thread {
	...
	public void run() {
		try {
			...
			String link = "https://ease.space/registerInv?email=" + toEmail + "&code=" + invitationCode;
			...
			message.setContent("<div style='color: black;'><p>***English version below***<br /></p>"
					...
					+ "<p>Le service informatique a déjà pré-créé votre compte avec votre email IÉSEG, pour le finaliser veuillez cliquer ici: <a href='" + link + "' target='_blank'>https://ease.space/ieseg</a><br /></p>"
					...
					+ "<p>The IT department already pre-created your account with your IÉSEG email. To finalize it, please click here: <a href='" + link + "' target='_blank'>https://ease.space/ieseg</a><br /></p>"
