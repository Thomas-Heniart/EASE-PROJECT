...
CREATE DATABASE ease DEFAULT CHARSET UTF8;
...
CREATE TABLE `METRIC_CONNECTION` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45083 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ONBOARDING_ROOM`
--

DROP TABLE IF EXISTS `ONBOARDING_ROOM`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `ONBOARDING_ROOM_WEBSITE`
--

DROP TABLE IF EXISTS `ONBOARDING_ROOM_WEBSITE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ONBOARDING_ROOM_WEBSITE` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `onboarding_room_id` (`onboarding_room_id`,`website_id`),
  KEY `website_id` (`website_id`),
  CONSTRAINT `onboarding_room_website_ibfk_1` FOREIGN KEY (`onboarding_room_id`) REFERENCES `ONBOARDING_ROOM` (`id`),
  CONSTRAINT `onboarding_room_website_ibfk_2` FOREIGN KEY (`website_id`) REFERENCES `websites` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `TEAM_ONBOARDING_STATUS`
--

DROP TABLE IF EXISTS `TEAM_ONBOARDING_STATUS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32328 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32194 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `profileInfo` (
  ...
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8484 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9351 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=31226 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30752 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teamSingleSoftwareCards` (
  ...
  PRIMARY KEY (`id`),
  KEY `account_id` (`account_id`),
  KEY `teamsinglesoftwarecards_ibfk_3` (`teamUser_filler_id`),
...
CREATE TABLE `teams` (
  ...
  `onboarding_status_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `onboarding_status_id` (`onboarding_status_id`),
  CONSTRAINT `teams_ibfk_1` FOREIGN KEY (`onboarding_status_id`) REFERENCES `TEAM_ONBOARDING_STATUS` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `jwt_id` (`jwt_id`),
  KEY `users_ibfk_5` (`post_registration_emails_id`),
  ...
  CONSTRAINT `users_ibfk_6` FOREIGN KEY (`personal_information_id`) REFERENCES `USER_PERSONAL_INFORMATION` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3089 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE easeLogs DEFAULT CHARSET UTF8;
...
-- Dump completed on 2018-01-19 13:34:18
