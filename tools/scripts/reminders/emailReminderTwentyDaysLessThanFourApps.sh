...
function sendEmail() {
	...
	--data '{"personalizations": [{"to": [{"email":"'$email'", "name":"'$name'"}], "substitutions": {"#username": "'$name'", "#linkUrl": "http://localhost:8080/index.jsp?importAccounts=true"}}], "from": {"email":"benjamin@ease.space", "name":"Benjamin"}, "template_id": "60c9fb19-7403-402a-b275-031f646be86e"}'
}
