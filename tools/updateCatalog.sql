...
ADD COLUMN ratio INT(10) UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE websites
ADD COLUMN position INT(10) NOT NULL;
ALTER TABLE websites
ADD COLUMN insertDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE websites
ADD COLUMN locked TINYINT(1) UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE websites
ADD COLUMN lockedExpiration DATETIME NOT NULL;
