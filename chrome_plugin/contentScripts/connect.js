...
/* extension.runtime.onMessage("checkChromeSettings", function(msg, sendResponse) {
    console.log("Je suis là.");
    $(document).ready(function() {
        waitfor($("#advanced-settings-expander"), function() {
            console.log($(this));
            $(this).click(function() {
                waitfor($("#password-manager-enabled"), function() {
                    console.log($(this));
                });
            });
        });
