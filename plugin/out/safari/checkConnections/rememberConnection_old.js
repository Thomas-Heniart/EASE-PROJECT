...
/*getDOM(urlToCheck, function (xhrRes) {
            document.documentElement.innerHTML = xhrRes;
                checkCo();
            }
            validator = true;
        })*/

/*extension.runtime.bckgrndOnMessage("newRequest", function(message, sender, sendReponse){
    console.log(message);
});*/
