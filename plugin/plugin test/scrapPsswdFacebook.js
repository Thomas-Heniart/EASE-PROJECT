...
if (window.top === window) {
    ...
    text1.innerText = "Collecting apps where you signed in with Facebook";
    text1.className ="big";
    ...
    progressLoading(((Math.random()*0.5)+0.5)*progressTotal, 8000);
