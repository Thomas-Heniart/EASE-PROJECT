...
$('body').prepend('<div id="ease_extension" safariVersion="2.2.2" style="dislay:none;">');
...
document.addEventListener("NewLinkToOpen", function(event){
    if(event.detail.highlight == undefined) event.detail.highlight = true;
    extension.runtime.sendMessage("NewLinkToOpen",{"highlight":event.detail.highlight, "detail":event.detail}, function(response) {});
}, false);
