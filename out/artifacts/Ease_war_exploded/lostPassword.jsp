...
<div class="lostPasswordBlock" id="lostPassword">
    ...
    <form action="ResetPassword" id="lostPasswordForm" style="text-align: center;">
        <div id="security" class="show">
            <p>For security reasons, resetting your EASE password will delete all accounts password you added to the
                platform.</p>
        </div>
        <div id="enterEmail">
        ...
        <span class="input input--minoru">
				<input style="text-align: center;" class="input__field input__field--minoru" name="email" type="email"
                       id="input-8" placeholder="Email"/>
