...
import {Message, Input, Label,Form, Menu, Icon, Container, Button} from 'semantic-ui-react';
import SimpleModalTemplate from "../common/SimpleModalTemplate";
import {showTeamAnyEnterpriseAppSettingsModal} from "../../actions/modalActions";
...
import {
  removeTeamCardReceiver, teamEditAnyEnterpriseCard,
...
class TeamAnyEnterpriseAppSettingsModal extends Component {
  ...
  close = () => {
    this.props.dispatch(showTeamAnyEnterpriseAppSettingsModal({active: false}));
  };
  remove = () => {
  ...
  edit = (e) => {
    ...
    if (this.state.url !== this.props.app.website.landing_url)
      calls.push(this.props.dispatch(teamEditAnyEnterpriseCard({
        team_card_id: team_app.id,
        name: team_app.name,
        ...
        connection_information: team_app.website.information
      })));
...
export default TeamAnyEnterpriseAppSettingsModal;
