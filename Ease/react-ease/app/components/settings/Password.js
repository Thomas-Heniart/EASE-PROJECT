          ...
          <Segment clearing>
            ...
            <Form onSubmit={this.confirm} size='mini' error={this.state.errorMessage.length > 0}>
                ...
                <Form.Field>
                  ...
                  <Message
                    content={'Your password must contain at least 8 characters, 1 uppercase, 1 lowercase and 1 number.'}/>
                  }
                </Form.Field>
                <Form.Field>
                    <Form.Input className='inputInSegment'
                ...
                <Message error content={this.state.errorMessage}/>
                <p>Take care of remembering this password. In case you loose it, for safety reasons all passwords on
                    your Ease.space account will be deleted and you will have to add them again. </p>
                <Form.Field>
                    <Button type='submit'
                            content='Save'
                            color={'blue'}
