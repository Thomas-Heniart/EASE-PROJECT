  ...
  render() {
    return (
      <Segment>
        ...
        <div>
          <Checkbox toggle checked={this.props.common.homepage} onChange={this.toggleHomepage}
        ...
        <div>
          <Checkbox toggle checked={this.state.background} onChange={this.toggleBackground}
