      ...
      <div class="team_plan" id="starter_plan" style={{marginRight: '40px'}}>
        ...
        <div class="text-center" style={{marginBottom: '35px'}}>
          <button class="button-unstyle big-button button">
            <NavLink to={`/main/simpleTeamCreation?plan_id=0`} className="link-unstyle" activeClassName="active">
              CREATE A FREE TEAM
            </NavLink>
          </button>
        </div>
        <span class="info">INCLUDED IN THE <TeamPlanPopup text={'to handle passwords accessible by team members'} trigger={<span class="text-underlined">TEAM SPACE</span>}/> <TeamPlanPopup text={'to handle passwords accessible by team members'} trigger={<Icon link name="help circle outline"/>}/></span>
        <div class="display-flex flex_direction_column full_flex">
          ...
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span>Up to 4 <TeamPlanPopup text={'Rooms group the people  who work together so sharing & organizing passwords is easier'} trigger={<span class="text-underlined">rooms</span>}/></span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span>1 <TeamPlanPopup text={'Admins can activate, deactivate members, give them access to tools…'} trigger={<span class="text-underlined">Admin</span>}/></span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span><TeamPlanPopup text={'Notifications makes it all work smoothly, it simplifies interacting with team members'} trigger={<span class="text-underlined">Notifications</span>}/></span>
          </div>
        </div>
  ...
  return (
      <div class="team_plan" id="pro_team_plan" style={{marginRight: '40px'}}>
        ...
        <div class="display-flex flex_direction_column">
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span>Unlimited <TeamPlanPopup text={'Rooms group the people  who work together so sharing & organizing passwords is easier'} trigger={<span class="text-underlined">rooms</span>}/></span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
          ...
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span><TeamPlanPopup text={'Room managers are responsible to administer people and apps accesses within a room'} trigger={<span class="text-underlined">Room Managers</span>}/> set up</span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span>Automatic <TeamPlanPopup text={'You can set up departure dates on members to remove accesses automatically'} trigger={<span class="text-underlined">access removal</span>}/></span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
  ...
  return (
      <div class="team_plan" id="enterprise_team_plan">
        ...
        <div class="display-flex flex_direction_column full_flex">
          <div class="feature">
            <i class="fa fa-check tic"/>
            <span><TeamPlanPopup text={'Companies using an internal SSO can integrate Ease.space'} trigger={<span class="text-underlined">Single Sign-on</span>}/> integration (SSO)</span>
          </div>
          <div class="feature">
            <i class="fa fa-check tic"/>
...
function Step2(props){
  return (
      <div class="content display-flex flex_direction_column marginAuto step2">
        ...
        <span class="sub-title">* a user is active from the day he/she shares or receives an app in his/her Team Space</span>
      </div>
  )
}
