        ...
        <div class="contents" id="step1">
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <div style={{textAlign: "right"}}>
              <button class="button-unstyle"><u>I already have an account</u></button>
            </div>
...
class Step4 extends React.Component{
  ...
  onSubmit(e){
    e.preventDefault();
    post_api.common.registration(this.props.email, this.props.username, this.props.password, this.props.digits, this.props.newsletter).then(response => {
      this.props.onStepValidated();
    }).catch(err => {
...
class Step6 extends React.Component{
  ...
  onSubmit(e){
    e.preventDefault();
    post_api.teams.createTeam(this.props.teamName, this.props.email,this.props.first_name, this.props.last_name, this.props.username, this.props.jobRole, this.props.jobDetails, '').then(response => {
