...
const CredentialInputs = ({url, information, account_information, handleChange, toggle, seePassword, toggleSeePassword, edit, onlyPassword}) => {
  return (
    <React.Fragment>
      {url !== -1 &&
      <UrlInput url={url}/>}
