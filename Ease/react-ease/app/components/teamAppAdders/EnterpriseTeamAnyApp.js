...
import {
  ...
  teamEnterpriseCardPasswordScoreAlert, teamEnterpriseCardReceiverPasswordScoreAlert
...
class EnterpriseTeamAnyApp extends Component {
  ...
  setEdit = (state) => {
    if (state){
      ...
      const app = this.props.app;
      this.setupUsers();
      this.setState({password_reminder_interval: app.password_reminder_interval, description: app.description, name: app.name, url: app.website.landing_url, img_url: app.website.logo});
    }
  ...
  modify = (e) => {
    ...
    this.props.dispatch(teamEditAnyEnterpriseCard({
      team_card_id: this.props.app.id,
      ...
      connection_information: this.props.app.website.information
    })).then(response => {
      const app = response;
                ...
                <div class="credentials">
                  <div class="display-inline-flex align_items_center">
                    <Input
                        ...
                        value={!this.state.edit ? website.landing_url : this.state.url}
                        type={'text'}>
                    </Input>
                    {!this.state.edit ?
                        <PasswordChangeHolderEnterprise
...
module.exports = EnterpriseTeamAnyApp;