...
var ReactInput = function (_React$Component) {
	...
	function ReactInput(props) {
		...
		var _this = (0, _possibleConstructorReturn3.default)(this, (ReactInput.__proto__ || (0, _getPrototypeOf2.default)(ReactInput)).call(this, props));
		...
		_this.input_controller = new _inputController2.default(_this.get_input_element, parse, format, onChange);
		return _this;
	}
