...
<script src="/jsMinified.v00011/tracker.js"></script>
	...
	<div id="g">
        ...
        <div class="col-md-6">
            ...
            <div data-mercury="froala" data-content-name="cta_content">
              ...
              <input id="email" class="required form-control " type="email" name="email" placeholder="Start unregistering from Ease" data-label-text="Email">
              
            </div>
          
          <div class="form-group">
            <input type="submit" id="submit_button" class="btn btn-lg btn-yellow subscribe-submit" name="submit" value="Start the process"/>
          </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".container, .flex-container").fitVids();
        ...
        <script>
          $(function(){   
            var share_options = {"networks":[{"network":"facebook","icon":"facebook"},{"network":"twitter","icon":"twitter"},{"network":"email","icon":"envelope"}],"share_text":"Ease - Share it if you love it","body":"Hey, \r\nI just discovered this new website: Ease the first web-life organization platform !\r\n\r\nTalk to you soon :)\r\n","subject":"Ease - Share it if you love it","page_title":"Ease: We secure your web-life"}; 
