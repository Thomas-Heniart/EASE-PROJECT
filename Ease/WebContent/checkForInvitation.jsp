...
<body id="invitationBody">
	<div class="invitation-header">
		...
		<div class="header-content">
			...
			<form oClass="GetEmailForm" id="GetEmailForm" action="getEmailLink">
				<input type="text" oClass="NoEmptyInput" name="email" placeholder="Enter your email"/><button type="submit" class="openRegisterPopup">Go</button>
	...
	<div class="invitation-content">
		...
		<div class="content-item">
			...
			<video width="720" height="460" loop autoplay>
		...
		<div class="invitation-footer">
			...
			<div class="business">
				...
				<p>Users data remain anonymous and are not used for commercial purposes. Our business is to sell user licences to schools that have multiple platforms: intranet, e-learnings, online schedule, alumni network, etc.</p>
			</div>
			...
			<div class="contact">
				<div class="security-cgu">
					<a href="http://www.ease-app.co/security" target="_blank">Security</a>
