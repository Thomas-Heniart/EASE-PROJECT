...
<div class="md-modal md-effect-15 popup" id="PopupModifyProfile">
	<div class="md-content">
		<h3>Modify your profile !</h3>
		<div class="form">
		<form action="editProfile" method="POST" id="FormModifyProfile" role="form">
				<input name="index" type="hidden" id="index" value=""/>
