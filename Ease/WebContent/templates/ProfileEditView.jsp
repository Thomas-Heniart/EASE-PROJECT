...
$(document).ready(function(){
	...
	$('.helpIntegrateApps #integrateAppForm .buttonSet #integrate').click(function(){
		var form = $(this).closest('#integrateAppForm');
		$(form).find('.inputs p').removeClass('hidden');
		$(form).find('.inputs input').addClass('hidden');
		$(form).find('.buttonSet .hidden').removeClass('hidden');
		$(form).find('.buttonSet #integrate').addClass('hidden');
		$.post(
			'askForNewApp',
				{
