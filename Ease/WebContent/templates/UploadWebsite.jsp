            ...
            <form method="post" id="addSiteForm" action="addWebsite">
                <input type="text" name="siteUrl" class="form-control"
                       placeholder="Website url"/> <input type="text" name="homePage" class="form-control"
                                                          placeholder="Homepage url"/> <input type="text"
                                                                                              name="siteName"
                                                                                              class="form-control"
                ...
                <div class="form-control"
                    ...
                    <input
                            style="width: 20px; height: 20px; padding: 0; margin: 0; vertical-align: bottom; position: relative;"
                            type="checkbox" name="noScrap"/>noScrap
                </div>
                <div class="form-control"
                     style="margin-left: 25%; margin-top: 1%; width: 50%; text-align: center; position: relative;">
                    <label for="sso">Sso: </label>
                    <select size="1" name="sso" id="sso">
                        <option value=""></option>
                        <c:forEach items='${servletContext.getAttribute("catalog").getSsos()}' var="sso">
                            <option value="${sso.getDbid()}">${sso.getName()}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-control"
                ...
                <div id="websiteInformations"
                    ...
                    <div class='websiteInfo'>
                        ...
                        <input name='infoPlaceholder' type='text' class='form-control' value='Login'
                               placeholder='Placeholder'/>
                        <input name='infoPlaceholderIcon' type='text' class='form-control' value='fa-user-o'
                               placeholder='FA icon'/>
                    </div>
                    <div class='websiteInfo'>
                        <input name='infoName' type='text' class='form-control' value='password'
                               placeholder='Info name'/>
                        <input name='infoType' type='text' class='form-control' value='password'
                               placeholder='Info type'/>
                        <input name='infoPlaceholder' type='text' class='form-control' value='Password'
                               placeholder='Placeholder'/>
                        <input name='infoPlaceholderIcon' type='text' class='form-control' value='fa-lock'
                               placeholder='FA icon'/>
                    </div>
                </div>
                <button type="button" class='btn btn-default form-control' id="addInfo"
                        style="margin-left: 25%; margin-top: 1%; width: 50%; position: relative;">Add information
                </button>
