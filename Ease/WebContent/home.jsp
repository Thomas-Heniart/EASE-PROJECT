	...
	<%@ include file="/templates/TutorialView.jsp"%>
		<script type="text/javascript">
			window.addEventListener('load',function() {
				asyncLoading.loadScriptsOneByOne(["/jsMinified.v00009/tutorialSteps.js"]);
			});
		</script>
	</c:if>
...
<script src="/jsMinified.v00009/jquery-ui-1.12.0.js" defer></script>
<script src="/jsMinified.v00009/Sortable.js" defer></script>
<script src="/jsMinified.v00009/app.js" defer></script>
<script src="/jsMinified.v00009/profiles.js" defer></script>
<script src="/jsMinified.v00009/dashboard.js" defer></script>
<script src="/jsMinified.v00009/websocket.js" async></script>
<script src="/jsMinified.v00009/tracker.js" async></script>
<script src="/jsMinified.v00009/asyncContentLoading.js" async></script>
<script src="/jsMinified.v00009/postHandler.js" async></script>
<script src="/jsMinified.v00009/basic-utils.js" async></script>
<script src="/jsMinified.v00009/extension.js" async></script>
<script src="/jsMinified.v00009/header.js" async></script>
<script src="/jsMinified.v00009/selectFx.js" async></script>
<script src="/jsMinified.v00009/isMobile.js" async></script>
<script src="/jsMinified.v00009/shortcut.js" async></script>
<script src="/jsMinified.v00009/logout.js" async></script>
<script src="/jsMinified.v00009/checkConnection.js" async></script>
<script>
...
<script type="text/javascript">
	...
	window.addEventListener('load',function(){
		asyncLoading.loadHtml({
			...
			callback: function(){
				asyncLoading.loadScriptsOneByOne(
					[
					"/jsMinified.v00009/modifyAppPopup.js",
					"/jsMinified.v00009/addAppPopup.js",
					"/jsMinified.v00009/deleteAccountPopup.js",
					"/jsMinified.v00009/deleteProfilePopup.js",
					"/jsMinified.v00009/addBookmarkPopup.js",
					"/jsMinified.v00009/popupHandler.js"
					]
				);
			}
		});
		...
		asyncLoading.loadHtml({
			...
			callback: function(){
				asyncLoading.loadScriptsOneByOne(
					['/jsMinified.v00009/catalogApp.js',
					'/jsMinified.v00009/catalog.js',
					'/jsMinified.v00009/update.js',
					'/jsMinified.v00009/updatesManager.js'
					],
					function(){
		...
		asyncLoading.loadHtml({
			...
			appendTo : '#onComputer',
			callback : function(){
				asyncLoading.loadSingleScript("/jsMinified.v00009/footer.js");
			}
		});
	});
</script>
