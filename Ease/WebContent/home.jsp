...
<noscript id="deferred-styles">
	<link rel="stylesheet" href="/cssMinified.v00007/lib/niftyPopupWindow/component.css">
</noscript>
<script src="/jsMinified.v00008/jquery1.12.4.js" ></script>
<script src="/jsMinified.v00008/jquery-ui-1.12.0.js" defer></script>
<script src="/jsMinified.v00008/Sortable.js" defer></script>
<script src="/jsMinified.v00008/app.js" defer></script>
<script src="/jsMinified.v00008/profiles.js" defer></script>
<script src="/jsMinified.v00008/dashboard.js" defer></script>
<script src="/jsMinified.v00008/websocket.js" async></script>
<script src="/jsMinified.v00008/tracker.js" async></script>
<script src="/jsMinified.v00008/asyncContentLoading.js" async></script>
<script src="/jsMinified.v00008/postHandler.js" async></script>
<script src="/jsMinified.v00008/basic-utils.js" async></script>
<script src="/jsMinified.v00008/extension.js" async></script>
<script src="/jsMinified.v00008/header.js" async></script>
<script src="/jsMinified.v00008/selectFx.js" async></script>
<script src="/jsMinified.v00008/isMobile.js" async></script>
<script src="/jsMinified.v00008/shortcut.js" async></script>
<script src="/jsMinified.v00008/logout.js" async></script>
<script src="/jsMinified.v00008/checkConnection.js" async></script>
<script>
...
<script type="text/javascript">
	...
	window.addEventListener('load',function(){
		asyncLoading.loadHtml({
			...
			callback: function(){
				asyncLoading.loadScriptsOneByOne(
					[
					"/jsMinified.v00008/modifyAppPopup.js",
					"/jsMinified.v00008/addAppPopup.js",
					"/jsMinified.v00008/deleteAccountPopup.js",
					"/jsMinified.v00008/deleteProfilePopup.js",
					"/jsMinified.v00008/addBookmarkPopup.js",
					"/jsMinified.v00008/popupHandler.js"
					]
				);
			}
		});
		...
		asyncLoading.loadHtml({
			...
			callback: function(){
				asyncLoading.loadScriptsOneByOne(
					['/jsMinified.v00008/catalogApp.js',
					'/jsMinified.v00008/catalog.js',
					'/jsMinified.v00008/update.js',
					'/jsMinified.v00008/updatesManager.js'
					],
					function(){
		...
		asyncLoading.loadHtml({
			...
			appendTo : '#onComputer',
			callback : function(){
				asyncLoading.loadSingleScript("/jsMinified.v00008/footer.js");
			}
		});
	});
</script>
