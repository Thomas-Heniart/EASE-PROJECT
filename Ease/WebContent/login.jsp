...
<div id="onComputer">
    <div id="loginBody">
        ...
        <div class="popupHandler myshow">
                    ...
                    <div class="popupBody show">
                        <div class="handler">
                            <div class="row">
                                <div class="title">
                                    <p>
                                        Hello<br><span><%= new String(Base64.getDecoder().decode(fname), StandardCharsets.UTF_8) %></span>
                                        !</p>
                                </div>
                            </div>
                            <form method="POST" action="connection" id="knownUserForm">
                                ...
                                <div class="row">
                                    ...
                                    <a class="buttonLink floatRight createAccount" href="/discover">Create an
                                        account</a>
                                </div>
                            </form>
                        </div>
            ...
            <%}%>
            <!-- unknown user popup -->
            <div class="easePopup landingPopup <% if (!knownUser){ %><c:if test='${empty param.codeExpiration}'>show</c:if><% }%>"
                 id="unknownUser">
                <div class="bodysHandler">
                    <div class="popupBody show">
                        <div class="handler">
                            ...
                            <form method="POST" action="connection" id="unknownUserForm">
                                ...
                                <div class="row">
                                    <% if (knownUser) {%>
                                    <p class="buttonLink floatLeft knownAccountButton"><%= new String(Base64.getDecoder().decode(fname), StandardCharsets.UTF_8) %>
                                        's account</p>
                                    <%}%>
                                    <a class="buttonLink floatRight createAccount" href="/discover">Create an
                                        account</a>
            ...
            <!-- password lost popup -->
            <div class="easePopup landingPopup <c:if test='${not empty param.codeExpiration}'>show</c:if>"
                 id="passwordLost">
                <div class="bodysHandler">
                    <div class="popupBody show">
                        <div class="handler">
                            ...
                            <form method="POST" action="passwordLost" id="passwordLostForm">
                                <div class="row text-center">
                                    <p class="popupText">For security reasons, resetting your EASE password will delete
                                        all account passwords you added to the platform.</p>
                                </div>
                                <div class="row">
                                    <input type="email" name="email" placeholder="Email"/>
                                </div>
                                <div class="row alertDiv text-center <c:if test='${not empty param.codeExpiration}'>show</c:if>">
                                    <p><c:if
                                            test='${not empty param.codeExpiration}'>The link is not valid anymore, please type your email again.</c:if></p>
                                </div>
                                <div class="row text-center">
...
<script src="/jsMinified/postHandler.js" async></script>
<script src="/jsMinified/basic-utils.js" async></script>
<script src="/jsMinified/isMobile.js" async></script>
<script src="/jsMinified/connection.js" async></script>
<script src="/jsMinified/generalLogout.js" async></script>
<script src="/jsMinified/tracker.js" async></script>
<script src="/jsMinified/ajaxHandler.js" async></script>
<script src="/jsMinified/jsencrypt.js" async></script>
<script>
