    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (teamUser.isVerified()) {
                ...
                NotificationFactory.getInstance().createRemindTeamEnterpriseCardFiller(teamCard, teamUser, teamUser_connected, sm.getUserWebSocketManager(teamUser.getUser().getDb_id()), sm.getHibernateQuery());
            }
