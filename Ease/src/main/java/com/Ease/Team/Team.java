...
public class Team {
    ...
    public static final int RAIZER_ID = 209;
    ...
    public JSONObject getSimpleJson() throws HttpServletException {
        ...
        res.put("extra_members", this.getDb_id().equals(RAIZER_ID) ? 20 : this.getInvitedFriendMap().size());
        return res;
    }
    ...
    public int getExtraMembersCount() {
        return this.getDb_id().equals(RAIZER_ID) ? 30 : (MAX_MEMBERS + this.getInvitedFriendMap().size());
    }
