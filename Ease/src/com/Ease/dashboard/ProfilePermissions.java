...
public class ProfilePermissions extends Permissions {
	...
	public static Permissions loadProfilePermissions(String id, ServletManager sm) throws GeneralException {
	...
	public static Permissions loadDefaultProfilePermissions(ServletManager sm) throws GeneralException {
		return loadProfilePermissions(DEFAULT_PERM_ID, sm);
	}
	
	public static Permissions CreateProfilePermissions(int perms, String group_id, ServletManager sm) throws GeneralException {
		DataBaseConnection db = sm.getDB();
