...
@WebServlet("/ServletAddSoftwareApp")
public class ServletAddSoftwareApp extends HttpServlet {
    ...
    public void checkConnectionInformation(JSONObject connection_information) throws HttpServletException {
        try {

        } catch (Exception e) {
            throw new HttpServletException(HttpStatus.BadRequest, "Invalid parameter connection_information");
        }
    }
