        ...
        try {
            ...
            for (Team team : teamManager.getTeams(sm.getHibernateQuery())) {
                /* for (ShareableApp shareableApp : team.getAppManager().getShareableApps().values()) {
                    ...
                    team.getWebSocketManager().sendObject(WebSocketMessageFactory.createWebSocketMessage(WebSocketMessageType.TEAM_CARD, WebSocketMessageAction.REMOVED, app_id, target));
                } */
            }
