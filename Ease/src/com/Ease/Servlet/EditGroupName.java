...
/**
 * Servlet implementation class EditGroupName
 */
@WebServlet("/EditGroupName")
public class EditGroupName extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				Group groupToRename = groups.get(Integer.parseInt(single_id));
				if (groupToRename == null)
					throw new GeneralException(ServletManager.Code.ClientError, "This group does not exist.");
				groupToRename.getInfra().isAdmin(user, sm);
				groupToRename.setName(name, sm);
				sm.setResponse(ServletManager.Code.Success, "Group renamed");
