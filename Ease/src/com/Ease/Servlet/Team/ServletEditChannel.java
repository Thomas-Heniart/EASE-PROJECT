 ...
 */
@WebServlet("/ServletEditChannel")
public class ServletEditChannel extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            channel.edit(editJson);
            query.saveOrUpdateObject(channel);
            query.commit();
            sm.setResponse(ServletManager.Code.Success, "channel edited");
        } catch (Exception e) {
            sm.setResponse(e);
        }
        sm.sendResponse();
