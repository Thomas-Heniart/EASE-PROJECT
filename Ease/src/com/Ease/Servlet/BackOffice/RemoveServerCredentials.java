 ...
 */
@WebServlet("/removeServerCredentials")
public class RemoveServerCredentials extends HttpServlet {
	 ...
	 */
	public RemoveServerCredentials() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Get Parameters
		String login = sm.getServletParam("login", false);
		...
		try {
			...
			if (!user.isAdmin()) {
				...
				ServerKey.eraseServerKey(login,password, db);
